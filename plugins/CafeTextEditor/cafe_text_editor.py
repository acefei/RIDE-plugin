...
from cafe_ride.plugins.CafeTextEditor.breakpoint_manager import BreakPointRecoder
...
class SourceEditor(wx.Panel):
    ...
    def _create_editor_toolbar(self):
        ...
        default_components.add_with_padding(Label(self, label="Auto Save Frequency in min:"), padding=10)
        self.autosave_field = TextField(self, '', process_enters=True)
        self.autosave_field.Bind(wx.EVT_TEXT_ENTER, self.OnChangeTimer)
        default_components.add_with_padding(self.autosave_field)
